...
var dataCkp = window.dataCkp
    ...
    var CkpChartCanvas = $('#chartCkp').get(0).getContext('2d')
          ...
          new Chart(CkpChartCanvas, {
              type: 'line',
              data: CkpChartData,
              options: CkpChartOptions
            })
...
var dataAdu = window.dataAdu
    ...
    var AduChartCanvas = $('#chartAdu').get(0).getContext('2d')
          ...
          new Chart(AduChartCanvas, {
              type: 'line',
              data: AduChartData,
              options: AduChartOptions
            })
...
var dataQap = window.dataQap
    ...
    var QapChartCanvas = $('#chartQap').get(0).getContext('2d')
          ...
          new Chart(QapChartCanvas, {
              type: 'line',
              data: QapChartData,
              options: QapChartOptions
            })
...
var dataTbh = window.dataTbh
    ...
    var TbhChartCanvas = $('#chartTbh').get(0).getContext('2d')
          ...
          new Chart(TbhChartCanvas, {
              type: 'line',
              data: TbhChartData,
              options: TbhChartOptions
            })
//     $.ajax({
//       url: '/cakupan',
//       method: 'GET',
