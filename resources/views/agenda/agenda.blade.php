...
<div class="content-wrapper">
  ...
  <div class="content">
    <div class="float-right">
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalRapat" id="">TAMBAH</button>
      {{-- @endif --}}
    </div>
  <br><br>
  ...
  <fieldset class="border border-primary rounded">
    ...
    <div class="container">
      ...
      <div class="modal fade" id="modalRapat">
        <div class="modal-dialog modal-lg ">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title"  id="judul_rapat">KEGIATAN BARU</h4>
            ...
            <div class="modal-body">
                <fieldset class="border border-primary rounded">
                <legend class="ml-2 w-auto px-3 border border-primary rounded"><h6>IDENTITAS KEGIATAN</h6></legend>
                    <div class="container">
                        <!-- ================= TABLE HEADER BAHAN MASUK ================= -->
                                          <div class="table-responsive pompa-table">
                                              <table class="table table-bordered table-striped table-sm">
                                                  ...
                                                  <tbody>
                                                      <tr>
                                                          <td><textarea name="" class="form-control" id="" cols="30" rows="3"></textarea></td>
