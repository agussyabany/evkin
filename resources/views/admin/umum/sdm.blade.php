...
<div class="content-wrapper">
  ...
  <div class="content">
    <div class="float-right">
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-sdm" id="tambah_sdm">Tambah Data Keuangan</button>
    </div>
  <br><br>
              ...
              <fieldset class="border border-primary rounded">
                ...
                <div class="container">
                    <div class="row">
                      ...
                      {{-- hapus --}}
                      <div class="col form-group">
                        <label >Rasio Diklat Pegawai</label>
                        <input required type="number" class="form-control" name="" id="">
                      </div>
                      {{-- hapus --}}
                    </div>
